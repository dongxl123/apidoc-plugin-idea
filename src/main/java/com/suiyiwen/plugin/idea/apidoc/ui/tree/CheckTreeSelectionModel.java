...
public class CheckTreeSelectionModel extends DefaultTreeSelectionModel {
    ...
    // tells whether given path is checked.
    // if dig is true, then a path is assumed to be checked, if
    // one of its ancestor is checked.
    ...
    public void addSelectionPaths(TreePath[] paths) {
        ...
        // if all siblings are checked then unselect them and select parent recursively
    ...
    // tells whether all siblings of given path are checked.
    ...
    // if any ancestor node of given path is checked then unselect it
